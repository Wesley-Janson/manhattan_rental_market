...
ggsave("rent_counterfactual.png", width=128, height=96, units="mm")
...
ggsave("inventory_counterfactual.png", width=128, height=96, units="mm")
```
...
ggsave("CV-error.png", width=128, height=96, units="mm")
```
